...
emcc melvin.c melvin_wasm.c -o web/melvin.js -s WASM=1 -s EXPORTED_RUNTIME_METHODS='["ccall","cwrap","UTF8ToString","stringToUTF8"]' -s EXPORTED_FUNCTIONS='["_malloc","_free"]' -s ALLOW_MEMORY_GROWTH=1 -s INITIAL_MEMORY=16777216 -O2 -lm -std=c99
